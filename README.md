...
Master's Degree in Mathematics | Transformer Theory | Stochastic Processes | Scientific ML

I have a master's student in mathematics with four years of research and scientific computing experience with the Air Force Research Laboratory (AFRL).  My areas of practical expertise include self-supervised image representation learning, offline reinforcement learning, time series analysis, transformers, High-Performance Computing (HPC), Python, and dozens of scientific ML libraries. My theoretical expertise lies in probability theory, measure theory, Bayesian statistics, linear algebra, functional analysis, logic and metalogic.
